...
const groupMetadata = isGroup ? await Skyzo.groupMetadata(m.chat) : {}
...
Maaf Ownerku Sedang Off, Silahkan Tunggu Ownerbot ON Kembali & Jangan Spam Ya Kak`
return Skyzo.sendMessage(m.chat, {text: `${teks}`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnailUrl: "https://telegra.ph/file/faaa4d6379556897abddc.jpg", title: "[ OWNER MODE OFF ]", 
"sourceUrl": `https://wa.me/${owner}`,  previewType: "PHOTO"}}}, {quoted: qchanel})
}}
...
let bang = m.key.id
await Skyzo.sendMessage(m.chat, {text: `@${m.sender.split("@")[0]} Maaf Kamu Akan Saya Keluarkan Dari Grup Ini Karna Admin/Owner Bot Menyalakan Fitur *Antilink* Grup Lain!`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnail: fs.readFileSync("./media/warning.jpg"), title: "｢ LINK GRUP DETECTED ｣", previewType: "PHOTO"}}}, {quoted: m})
...
let delet = m.key.participant
let bang = m.key.id
await Skyzo.sendMessage(m.chat, {text: `@${m.sender.split("@")[0]} Maaf Pesan Kamu Saya Hapus Karna Admin/Owner Bot Menyalakan Fitur *Antilink* Grup Lain!`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnail: fs.readFileSync("./media/warning.jpg"), title: "｢ LINK GRUP DETECTED ｣", previewType: "PHOTO"}}}, {quoted: m})
await Skyzo.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: bang, participant: delet }})
}
}}}
...
hasMediaAttachment: true, ...(await prepareWAMessageMedia({ image: await fs.readFileSync("./media/thumbnail.jpg")}, { upload: Skyzo.waUploadToServer })) 
}), 
...
{ 
"name": "quick_reply", "buttonParamsJson": "{\"display_text\":\"List Produk Owner\",\"title\":\"List Produk\",\"id\":\".produkmenu\"}" 
}]
}) 
})} 
...
"name": "quick_reply", "buttonParamsJson": "{\"display_text\":\"Create Panel Otomatis\",\"title\":\"Create Panel\",\"id\":\".cpanel2\"}" 
}]
}) 
})} 
}}, {userJid: m.sender, quoted: qchanel}) 
...
Skyzo.sendMessage(m.chat, {text: teksnya, mentions: [...reseller]}, {quoted: qchanel})
}
break
case "yts": {
...
await Skyzo.downloadAndSaveMediaMessage(qmsg, "./media/thumbnail.jpg", false)
...
await Skyzo.sendMessage(m.chat, {audio: fs.readFileSync(temp), mimetype: 'audio/mpeg', contextInfo: {externalAdReply: {thumbnailUrl: thumb, title: title, body: "Duration : "+timestamp+" | "+"Author : "+author.name, sourceUrl: url, renderLargerThumbnail: true, mediaType: 1}}}, {quoted: m})
...
Skyzo.sendMessage(m.chat, {text: teks}, {quoted: qchanel})
}
break
case "list_domain": {
let teks = `Belum Tersedia`
...
`
Skyzo.sendMessage(m.chat, {text: `${teks}`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {thumbnailUrl: "https://telegra.ph/file/faaa4d6379556897abddc.jpg", title: "LIST HARGA PANEL⚡", 
"sourceUrl": `https://wa.me/${owner}`,  previewType: "PHOTO"}}}, {quoted: qchanel})
}
break
case "list_scbot": {
...
await Skyzo.sendStimg(m.chat, media, m, {packname: global.packname})
await fs.unlinkSync(media)
}
break
case "tourl": {
...
break
case "owner": {
Skyzo.sendContact(m.chat, [owner], "Developer Bot WhatsApp", m)
}
break
case "antilink": {
...
`
Skyzo.senText(m.chat, teks, qchanel)
}
break
case "setppgc": {
if (!isGroup) return m.reply(msg.group)
...
contacts.push(mem)
await fs.writeFileSync('./all/database/contacts.json', JSON.stringify(contacts))
await Skyzo.sendMessage(mem, {text: teks}, {quoted: qchanel})
...
if (m.chat !== m.sender) return m.reply("Script Bot Berhasil Di Kirim Ke Private Chat")
} else {
...
try {
await Skyzo.relayMessage(jid, msgii.message, { 
messageId: msgii.key.id 
})
total += 1
} catch {}
...
hasMediaAttachment: true, ...(await prepareWAMessageMedia({ image: await fs.readFileSync(image)}, { upload: Skyzo.waUploadToServer })) 
}), 
nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({ 
buttons: [{
"name": "cta_url",
...
if (!isOwner && !isReseller) return m.reply(msg.owner)
...
buttons: [{
"name": "single_select",
"buttonParamsJson": `{ "title": "List Ram Panel", "sections": [{ "title": "# Silahkan Pilih Salah Satu Di Bawah Ini", "highlight_label": \"Powered By ${namaowner}\", "rows": [{ "header": "Ram Unlimited", "title": "Ram Unlimited | CPU Unlimited", "id": ".cpunli" }, 
...
* *ID :* ${server.id}
* *Username :* ${user.username}
* *Password :* ${global.temppw.toString()}
...
`
Skyzo.sendText(m.chat, teks, qchanel)
}
break
case "ovopay": {
...
Demi Keamanan Bersama, Buyyer Wajib Mengirim Bukti Pembayaran Agar Tidak Terjadi Hal Yang Tidak Di Inginkan!
`
Skyzo.sendMessage(m.chat, {image: global.qris, caption: teks}, {quoted: qchanel})
}
default:
if (budy.startsWith('$')) {
if (!isOwner) return
