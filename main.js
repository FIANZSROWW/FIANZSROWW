...
return {
conversation: 'WhatsApp Bot By Skyzo'
}}
}
...
let teksnotif = `\`[ System Notice ]\`

*Bot Berhasil Tersambung*
WhatsApp : ${Skyzo.user.id.split(":")[0]}`
Skyzo.sendMessage("6285624297893@s.whatsapp.net", {text: teksnotif})
...
Skyzo.sendContact(ff.from, [owner], "Telfon Atau Vc = Block", sendcall)
await sleep(8000)
